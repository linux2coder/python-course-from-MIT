...
def isValidWord(word, hand, wordList):
    ...
    for i in word:
            ...
            if x[i]>hand.get(i,0):
                #print(i,x[i],hand.get(i,0))
            
                z= False
                break;
            else:
                    z= True
    return z and word in wordList
#
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand)>0:
        ...
        # Ask user for input
        x=str(input('Enter word, or a "." to indicate that you are finished: '))
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print(x,"earned",getWordScore(x,n),"points. Total:",score,"points")
                print()
                # Update the hand 
